...
import pytest
from src.business.requirements import (
    BusinessPriority,
    BusinessRequirement,
    ProjectRequirements
)
...
class TestProjectRequirements:
    ...
    def test_project_requirements_has_critical_requirements(self):
        ...
        critical_reqs = [r for r in project.requirements 
                        if r.priority == BusinessPriority.CRITICAL]
...
class TestBusinessRequirementsIntegration:
    ...
    def test_requirements_summary(self):
        ...
        summary = {
            ...
            "critical": len([r for r in project.requirements 
                            if r.priority == BusinessPriority.CRITICAL]),
            "high": len([r for r in project.requirements 
                        if r.priority == BusinessPriority.HIGH])
        }
